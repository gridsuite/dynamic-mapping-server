...
VALUES  ('generator_UNom', NULL, 2, NULL, now()::timestamp),
        ('generator_SNom', NULL, 2, NULL, now()::timestamp),
        ('generator_PNomTurb', NULL, 2, NULL, now()::timestamp),
        ('generator_PNomAlt', NULL, 2, NULL, now()::timestamp),
        ('generator_ExcitationPu', NULL, 0, 1, now()::timestamp),
        ('generator_MdPuEfd', NULL, 2, NULL, now()::timestamp),
        ('generator_H', NULL, 2, NULL, now()::timestamp),
        ('generator_DPu', NULL, 2, NULL, now()::timestamp),
        ('generator_SnTfo', NULL, 2, NULL, now()::timestamp),
        ('generator_UNomHV', NULL, 2, NULL, now()::timestamp),
        ('generator_UNomLV', NULL, 2, NULL, now()::timestamp),
        ('generator_UBaseHV', NULL, 2, NULL, now()::timestamp),
        ('generator_UBaseLV', NULL, 2, NULL, now()::timestamp),
        ('generator_RTfPu', NULL, 2, NULL, now()::timestamp),
        ('generator_XTfPu', NULL, 2, NULL, now()::timestamp),
        ('generator_RaPu', NULL, 2, NULL, now()::timestamp),
        ('generator_XlPu', NULL, 2, NULL, now()::timestamp),
        ('generator_XdPu', NULL, 2, NULL, now()::timestamp),
        ('generator_XpdPu', NULL, 2, NULL, now()::timestamp),
        ('generator_XppdPu', NULL, 2, NULL, now()::timestamp),
        ('generator_Tpd0', NULL, 2, NULL, now()::timestamp),
        ('generator_Tppd0', NULL, 2, NULL, now()::timestamp),
        ('generator_XqPu', NULL, 2, NULL, now()::timestamp),
        ('generator_XppqPu', NULL, 2, NULL, now()::timestamp),
        ('generator_Tppq0', NULL, 2, NULL, now()::timestamp),
        ('generator_md', NULL, 2, NULL, now()::timestamp),
        ('generator_mq', NULL, 2, NULL, now()::timestamp),
        ('generator_nd', NULL, 2, NULL, now()::timestamp),
        ('generator_nq', NULL, 2, NULL, now()::timestamp),
        ('URef_ValueIn', NULL, 2, 0, now()::timestamp),
        ('Pm_ValueIn', NULL, 2, 0, now()::timestamp),
        ('generator_P0Pu', 'p_pu', 2, NULL, now()::timestamp),
        ('generator_Q0Pu', 'q_pu', 2, NULL, now()::timestamp),
        ('generator_UPhase0', 'angle_pu', 2, NULL, now()::timestamp),
        ('generator_UseApproximation', NULL, 1, NULL, now()::timestamp),
        ('generator_U0Pu', 'v_pu', 2, NULL, now()::timestamp),
        ('generator_XpqPu', NULL, 2, NULL, now()::timestamp),
        ('generator_Tpq0', NULL, 2, NULL, now()::timestamp),
        ('governor_KGover', NULL, 2, NULL, now()::timestamp),
        ('governor_PMin', NULL, 2, NULL, now()::timestamp),
        ('governor_PMax', NULL, 2, NULL, now()::timestamp),
        ('governor_PNom', NULL, 2, NULL, now()::timestamp),
        ('voltageRegulator_LagEfdMin', NULL, 2, NULL, now()::timestamp),
        ('voltageRegulator_LagEfdMax', NULL, 2, NULL, now()::timestamp),
        ('voltageRegulator_EfdMinPu', NULL, 2, NULL, now()::timestamp),
        ('voltageRegulator_EfdMaxPu', NULL, 2, NULL, now()::timestamp),
        ('voltageRegulator_UsRefMinPu', NULL, 2, NULL, now()::timestamp),
        ('voltageRegulator_UsRefMaxPu', NULL, 2, NULL, now()::timestamp),
        ('voltageRegulator_Gain', NULL, 2, NULL, now()::timestamp),
        ('generator_AlphaPuPNom', NULL, 2, NULL, now()::timestamp),
        ('generator_PNom', 'pMax', 2, NULL, now()::timestamp),
        ('generator_PMin', 'pMin', 2, NULL, now()::timestamp),
        ('generator_PMax', 'pMax', 2, NULL, now()::timestamp),
        ('generator_LambdaPuSNom', NULL, 2, NULL, now()::timestamp),
        ('generator_QMax', NULL, 2, NULL, now()::timestamp),
        ('generator_QMin', NULL, 2, NULL, now()::timestamp);

INSERT INTO models_model_parameter_definitions (model_name, parameter_definition_name, origin)
VALUES ('GeneratorSynchronousThreeWindings', 'generator_UNom', 2),
       ('GeneratorSynchronousThreeWindings', 'generator_SNom', 2),
       ('GeneratorSynchronousThreeWindings', 'generator_PNomTurb', 2),
       ('GeneratorSynchronousThreeWindings', 'generator_PNomAlt', 2),
       ('GeneratorSynchronousThreeWindings', 'generator_ExcitationPu', 1),
       ('GeneratorSynchronousThreeWindings', 'generator_MdPuEfd', 2),
       ('GeneratorSynchronousThreeWindings', 'generator_H', 2),
       ('GeneratorSynchronousThreeWindings', 'generator_DPu', 2),
       ('GeneratorSynchronousThreeWindings', 'generator_SnTfo', 2),
       ('GeneratorSynchronousThreeWindings', 'generator_UNomHV', 2),
       ('GeneratorSynchronousThreeWindings', 'generator_UNomLV', 2),
       ('GeneratorSynchronousThreeWindings', 'generator_UBaseHV', 2),
       ('GeneratorSynchronousThreeWindings', 'generator_UBaseLV', 2),
       ('GeneratorSynchronousThreeWindings', 'generator_RTfPu', 2),
       ('GeneratorSynchronousThreeWindings', 'generator_XTfPu', 2),
       ('GeneratorSynchronousThreeWindings', 'generator_RaPu', 2),
       ('GeneratorSynchronousThreeWindings', 'generator_XlPu', 2),
       ('GeneratorSynchronousThreeWindings', 'generator_XdPu', 2),
       ('GeneratorSynchronousThreeWindings', 'generator_XpdPu', 2),
       ('GeneratorSynchronousThreeWindings', 'generator_XppdPu', 2),
       ('GeneratorSynchronousThreeWindings', 'generator_Tpd0', 2),
       ('GeneratorSynchronousThreeWindings', 'generator_Tppd0', 2),
       ('GeneratorSynchronousThreeWindings', 'generator_XqPu', 2),
       ('GeneratorSynchronousThreeWindings', 'generator_XppqPu', 2),
       ('GeneratorSynchronousThreeWindings', 'generator_Tppq0', 2),
       ('GeneratorSynchronousThreeWindings', 'generator_md', 2),
       ('GeneratorSynchronousThreeWindings', 'generator_mq', 2),
       ('GeneratorSynchronousThreeWindings', 'generator_nd', 2),
       ('GeneratorSynchronousThreeWindings', 'generator_nq', 2),
       ('GeneratorSynchronousThreeWindings', 'URef_ValueIn', 1),
       ('GeneratorSynchronousThreeWindings', 'Pm_ValueIn', 1),
       ('GeneratorSynchronousThreeWindings', 'generator_P0Pu', 0),
       ('GeneratorSynchronousThreeWindings', 'generator_Q0Pu', 0),
       ('GeneratorSynchronousThreeWindings', 'generator_UPhase0', 0),
       ('GeneratorSynchronousThreeWindings', 'generator_UseApproximation', 2),
       ('GeneratorSynchronousThreeWindings', 'generator_U0Pu', 0);

INSERT INTO models_model_parameter_definitions (model_name, parameter_definition_name, origin)
VALUES ('GeneratorSynchronousFourWindings', 'generator_UNom', 2),
       ('GeneratorSynchronousFourWindings', 'generator_SNom', 2),
       ('GeneratorSynchronousFourWindings', 'generator_PNomTurb', 2),
       ('GeneratorSynchronousFourWindings', 'generator_PNomAlt', 2),
       ('GeneratorSynchronousFourWindings', 'generator_ExcitationPu', 1),
       ('GeneratorSynchronousFourWindings', 'generator_MdPuEfd', 2),
       ('GeneratorSynchronousFourWindings', 'generator_H', 2),
       ('GeneratorSynchronousFourWindings', 'generator_DPu', 2),
       ('GeneratorSynchronousFourWindings', 'generator_SnTfo', 2),
       ('GeneratorSynchronousFourWindings', 'generator_UNomHV', 2),
       ('GeneratorSynchronousFourWindings', 'generator_UNomLV', 2),
       ('GeneratorSynchronousFourWindings', 'generator_UBaseHV', 2),
       ('GeneratorSynchronousFourWindings', 'generator_UBaseLV', 2),
       ('GeneratorSynchronousFourWindings', 'generator_RTfPu', 2),
       ('GeneratorSynchronousFourWindings', 'generator_XTfPu', 2),
       ('GeneratorSynchronousFourWindings', 'generator_RaPu', 2),
       ('GeneratorSynchronousFourWindings', 'generator_XlPu', 2),
       ('GeneratorSynchronousFourWindings', 'generator_XdPu', 2),
       ('GeneratorSynchronousFourWindings', 'generator_XpdPu', 2),
       ('GeneratorSynchronousFourWindings', 'generator_XppdPu', 2),
       ('GeneratorSynchronousFourWindings', 'generator_Tpd0', 2),
       ('GeneratorSynchronousFourWindings', 'generator_Tppd0', 2),
       ('GeneratorSynchronousFourWindings', 'generator_XqPu', 2),
       ('GeneratorSynchronousFourWindings', 'generator_XppqPu', 2),
       ('GeneratorSynchronousFourWindings', 'generator_Tppq0', 2),
       ('GeneratorSynchronousFourWindings', 'generator_md', 2),
       ('GeneratorSynchronousFourWindings', 'generator_mq', 2),
       ('GeneratorSynchronousFourWindings', 'generator_nd', 2),
       ('GeneratorSynchronousFourWindings', 'generator_nq', 2),
       ('GeneratorSynchronousFourWindings', 'generator_XpqPu', 2),
       ('GeneratorSynchronousFourWindings', 'generator_Tpq0', 2),
       ('GeneratorSynchronousFourWindings', 'URef_ValueIn', 1),
       ('GeneratorSynchronousFourWindings', 'Pm_ValueIn', 1),
       ('GeneratorSynchronousFourWindings', 'generator_P0Pu', 0),
       ('GeneratorSynchronousFourWindings', 'generator_Q0Pu', 0),
       ('GeneratorSynchronousFourWindings', 'generator_UPhase0', 0),
       ('GeneratorSynchronousFourWindings', 'generator_UseApproximation', 2),
       ('GeneratorSynchronousFourWindings', 'generator_U0Pu', 0);

INSERT INTO models_model_parameter_definitions (model_name, parameter_definition_name, origin)
VALUES ('GeneratorSynchronousThreeWindingsProportionalRegulations', 'generator_UNom', 2),
       ('GeneratorSynchronousThreeWindingsProportionalRegulations', 'generator_SNom', 2),
       ('GeneratorSynchronousThreeWindingsProportionalRegulations', 'generator_PNomTurb', 2),
       ('GeneratorSynchronousThreeWindingsProportionalRegulations', 'generator_PNomAlt', 2),
       ('GeneratorSynchronousThreeWindingsProportionalRegulations', 'generator_ExcitationPu', 1),
       ('GeneratorSynchronousThreeWindingsProportionalRegulations', 'generator_MdPuEfd', 2),
       ('GeneratorSynchronousThreeWindingsProportionalRegulations', 'generator_H', 2),
       ('GeneratorSynchronousThreeWindingsProportionalRegulations', 'generator_DPu', 2),
       ('GeneratorSynchronousThreeWindingsProportionalRegulations', 'generator_SnTfo', 2),
       ('GeneratorSynchronousThreeWindingsProportionalRegulations', 'generator_UNomHV', 2),
       ('GeneratorSynchronousThreeWindingsProportionalRegulations', 'generator_UNomLV', 2),
       ('GeneratorSynchronousThreeWindingsProportionalRegulations', 'generator_UBaseHV', 2),
       ('GeneratorSynchronousThreeWindingsProportionalRegulations', 'generator_UBaseLV', 2),
       ('GeneratorSynchronousThreeWindingsProportionalRegulations', 'generator_RTfPu', 2),
       ('GeneratorSynchronousThreeWindingsProportionalRegulations', 'generator_XTfPu', 2),
       ('GeneratorSynchronousThreeWindingsProportionalRegulations', 'generator_RaPu', 2),
       ('GeneratorSynchronousThreeWindingsProportionalRegulations', 'generator_XlPu', 2),
       ('GeneratorSynchronousThreeWindingsProportionalRegulations', 'generator_XdPu', 2),
       ('GeneratorSynchronousThreeWindingsProportionalRegulations', 'generator_XpdPu', 2),
       ('GeneratorSynchronousThreeWindingsProportionalRegulations', 'generator_XppdPu', 2),
       ('GeneratorSynchronousThreeWindingsProportionalRegulations', 'generator_Tpd0', 2),
       ('GeneratorSynchronousThreeWindingsProportionalRegulations', 'generator_Tppd0', 2),
       ('GeneratorSynchronousThreeWindingsProportionalRegulations', 'generator_XqPu', 2),
       ('GeneratorSynchronousThreeWindingsProportionalRegulations', 'generator_XppqPu', 2),
       ('GeneratorSynchronousThreeWindingsProportionalRegulations', 'generator_Tppq0', 2),
       ('GeneratorSynchronousThreeWindingsProportionalRegulations', 'generator_md', 2),
       ('GeneratorSynchronousThreeWindingsProportionalRegulations', 'generator_mq', 2),
       ('GeneratorSynchronousThreeWindingsProportionalRegulations', 'generator_nd', 2),
       ('GeneratorSynchronousThreeWindingsProportionalRegulations', 'generator_nq', 2),
       ('GeneratorSynchronousThreeWindingsProportionalRegulations', 'governor_KGover', 2),
       ('GeneratorSynchronousThreeWindingsProportionalRegulations', 'governor_PMin', 2),
       ('GeneratorSynchronousThreeWindingsProportionalRegulations', 'governor_PMax', 2),
       ('GeneratorSynchronousThreeWindingsProportionalRegulations', 'governor_PNom', 2),
       ('GeneratorSynchronousThreeWindingsProportionalRegulations', 'voltageRegulator_LagEfdMin', 2),
       ('GeneratorSynchronousThreeWindingsProportionalRegulations', 'voltageRegulator_LagEfdMax', 2),
       ('GeneratorSynchronousThreeWindingsProportionalRegulations', 'voltageRegulator_EfdMinPu', 2),
       ('GeneratorSynchronousThreeWindingsProportionalRegulations', 'voltageRegulator_EfdMaxPu', 2),
       ('GeneratorSynchronousThreeWindingsProportionalRegulations', 'voltageRegulator_UsRefMinPu', 2),
       ('GeneratorSynchronousThreeWindingsProportionalRegulations', 'voltageRegulator_UsRefMaxPu', 2),
       ('GeneratorSynchronousThreeWindingsProportionalRegulations', 'voltageRegulator_Gain', 2),
       ('GeneratorSynchronousThreeWindingsProportionalRegulations', 'URef_ValueIn', 1),
       ('GeneratorSynchronousThreeWindingsProportionalRegulations', 'Pm_ValueIn', 1),
       ('GeneratorSynchronousThreeWindingsProportionalRegulations', 'generator_P0Pu', 0),
       ('GeneratorSynchronousThreeWindingsProportionalRegulations', 'generator_Q0Pu', 0),
       ('GeneratorSynchronousThreeWindingsProportionalRegulations', 'generator_UPhase0', 0),
       ('GeneratorSynchronousThreeWindingsProportionalRegulations', 'generator_UseApproximation', 2),
       ('GeneratorSynchronousThreeWindingsProportionalRegulations', 'generator_U0Pu', 0);

INSERT INTO models_model_parameter_definitions (model_name, parameter_definition_name, origin)
VALUES ('GeneratorSynchronousFourWindingsProportionalRegulations', 'generator_UNom', 2),
       ('GeneratorSynchronousFourWindingsProportionalRegulations', 'generator_SNom', 2),
       ('GeneratorSynchronousFourWindingsProportionalRegulations', 'generator_PNomTurb', 2),
       ('GeneratorSynchronousFourWindingsProportionalRegulations', 'generator_PNomAlt', 2),
       ('GeneratorSynchronousFourWindingsProportionalRegulations', 'generator_ExcitationPu', 1),
       ('GeneratorSynchronousFourWindingsProportionalRegulations', 'generator_MdPuEfd', 2),
       ('GeneratorSynchronousFourWindingsProportionalRegulations', 'generator_H', 2),
       ('GeneratorSynchronousFourWindingsProportionalRegulations', 'generator_DPu', 2),
       ('GeneratorSynchronousFourWindingsProportionalRegulations', 'generator_SnTfo', 2),
       ('GeneratorSynchronousFourWindingsProportionalRegulations', 'generator_UNomHV', 2),
       ('GeneratorSynchronousFourWindingsProportionalRegulations', 'generator_UNomLV', 2),
       ('GeneratorSynchronousFourWindingsProportionalRegulations', 'generator_UBaseHV', 2),
       ('GeneratorSynchronousFourWindingsProportionalRegulations', 'generator_UBaseLV', 2),
       ('GeneratorSynchronousFourWindingsProportionalRegulations', 'generator_RTfPu', 2),
       ('GeneratorSynchronousFourWindingsProportionalRegulations', 'generator_XTfPu', 2),
       ('GeneratorSynchronousFourWindingsProportionalRegulations', 'generator_RaPu', 2),
       ('GeneratorSynchronousFourWindingsProportionalRegulations', 'generator_XlPu', 2),
       ('GeneratorSynchronousFourWindingsProportionalRegulations', 'generator_XdPu', 2),
       ('GeneratorSynchronousFourWindingsProportionalRegulations', 'generator_XpdPu', 2),
       ('GeneratorSynchronousFourWindingsProportionalRegulations', 'generator_XppdPu', 2),
       ('GeneratorSynchronousFourWindingsProportionalRegulations', 'generator_Tpd0', 2),
       ('GeneratorSynchronousFourWindingsProportionalRegulations', 'generator_Tppd0', 2),
       ('GeneratorSynchronousFourWindingsProportionalRegulations', 'generator_XqPu', 2),
       ('GeneratorSynchronousFourWindingsProportionalRegulations', 'generator_XppqPu', 2),
       ('GeneratorSynchronousFourWindingsProportionalRegulations', 'generator_Tppq0', 2),
       ('GeneratorSynchronousFourWindingsProportionalRegulations', 'generator_md', 2),
       ('GeneratorSynchronousFourWindingsProportionalRegulations', 'generator_mq', 2),
       ('GeneratorSynchronousFourWindingsProportionalRegulations', 'generator_nd', 2),
       ('GeneratorSynchronousFourWindingsProportionalRegulations', 'generator_nq', 2),
       ('GeneratorSynchronousFourWindingsProportionalRegulations', 'generator_XpqPu', 2),
       ('GeneratorSynchronousFourWindingsProportionalRegulations', 'generator_Tpq0', 2),
       ('GeneratorSynchronousFourWindingsProportionalRegulations', 'governor_KGover', 2),
       ('GeneratorSynchronousFourWindingsProportionalRegulations', 'governor_PMin', 2),
       ('GeneratorSynchronousFourWindingsProportionalRegulations', 'governor_PMax', 2),
       ('GeneratorSynchronousFourWindingsProportionalRegulations', 'governor_PNom', 2),
       ('GeneratorSynchronousFourWindingsProportionalRegulations', 'voltageRegulator_LagEfdMin', 2),
       ('GeneratorSynchronousFourWindingsProportionalRegulations', 'voltageRegulator_LagEfdMax', 2),
       ('GeneratorSynchronousFourWindingsProportionalRegulations', 'voltageRegulator_EfdMinPu', 2),
       ('GeneratorSynchronousFourWindingsProportionalRegulations', 'voltageRegulator_EfdMaxPu', 2),
       ('GeneratorSynchronousFourWindingsProportionalRegulations', 'voltageRegulator_UsRefMinPu', 2),
       ('GeneratorSynchronousFourWindingsProportionalRegulations', 'voltageRegulator_UsRefMaxPu', 2),
       ('GeneratorSynchronousFourWindingsProportionalRegulations', 'voltageRegulator_Gain', 2),
       ('GeneratorSynchronousFourWindingsProportionalRegulations', 'URef_ValueIn', 1),
       ('GeneratorSynchronousFourWindingsProportionalRegulations', 'Pm_ValueIn', 1),
       ('GeneratorSynchronousFourWindingsProportionalRegulations', 'generator_P0Pu', 0),
       ('GeneratorSynchronousFourWindingsProportionalRegulations', 'generator_Q0Pu', 0),
       ('GeneratorSynchronousFourWindingsProportionalRegulations', 'generator_UPhase0', 0),
       ('GeneratorSynchronousFourWindingsProportionalRegulations', 'generator_UseApproximation', 2),
       ('GeneratorSynchronousFourWindingsProportionalRegulations', 'generator_U0Pu', 0);

INSERT INTO models_model_parameter_definitions (model_name, parameter_definition_name, origin)
VALUES ('GeneratorPQ', 'generator_AlphaPuPNom', 2),
       ('GeneratorPQ', 'generator_PNom', 0),
       ('GeneratorPQ', 'generator_PMin', 0),
       ('GeneratorPQ', 'generator_PMax', 0),
       ('GeneratorPQ', 'generator_P0Pu', 0),
       ('GeneratorPQ', 'generator_Q0Pu', 0),
       ('GeneratorPQ', 'generator_U0Pu', 0),
       ('GeneratorPQ', 'generator_UPhase0', 0);

INSERT INTO models_model_parameter_definitions (model_name, parameter_definition_name, origin)
VALUES ('GeneratorPV', 'generator_AlphaPuPNom', 2),
       ('GeneratorPV', 'generator_LambdaPuSNom', 2),
       ('GeneratorPV', 'generator_QMax', 2),
       ('GeneratorPV', 'generator_QMin', 2),
       ('GeneratorPV', 'generator_PNom', 0),
       ('GeneratorPV', 'generator_SNom', 2),
       ('GeneratorPV', 'generator_PMin', 0),
       ('GeneratorPV', 'generator_PMax', 0),
       ('GeneratorPV', 'generator_P0Pu', 0),
       ('GeneratorPV', 'generator_Q0Pu', 0),
       ('GeneratorPV', 'generator_U0Pu', 0),
       ('GeneratorPV', 'generator_UPhase0', 0);

INSERT INTO model_parameter_definitions (name, origin_name, type, created_date)
VALUES  ('load_alpha', NULL, 2, now()::timestamp),
        ('load_beta', NULL, 2, now()::timestamp),
        ('load_P0Pu', 'p_pu', 2, now()::timestamp),
        ('load_Q0Pu', 'q_pu', 2, now()::timestamp),
        ('load_U0Pu', 'v_pu', 2, now()::timestamp),
        ('load_UPhase0', 'angle_pu', 2, now()::timestamp);

INSERT INTO models_model_parameter_definitions (model_name, parameter_definition_name, origin)
VALUES ('LoadAlphaBeta', 'load_alpha', 2),
       ('LoadAlphaBeta', 'load_beta', 2),
       ('LoadAlphaBeta', 'load_P0Pu', 0),
       ('LoadAlphaBeta', 'load_Q0Pu', 0),
       ('LoadAlphaBeta', 'load_U0Pu', 0),
       ('LoadAlphaBeta', 'load_UPhase0', 0);

INSERT INTO models_model_parameter_definitions (model_name, parameter_definition_name, origin)
VALUES ('LoadPQ', 'load_P0Pu', 0),
       ('LoadPQ', 'load_Q0Pu', 0),
       ('LoadPQ', 'load_U0Pu', 0),
       ('LoadPQ', 'load_UPhase0', 0);

INSERT INTO model_parameter_definitions (name, origin_name, type, created_date)
VALUES
    ('currentLimitAutomaton_OrderToEmit', NULL, 0, now()::timestamp),
    ('currentLimitAutomaton_Running', NULL, 1, now()::timestamp),
    ('currentLimitAutomaton_IMax', NULL, 2, now()::timestamp),
    ('currentLimitAutomaton_tLagBeforeActing', NULL, 2, now()::timestamp);

INSERT INTO models_model_parameter_definitions (model_name, parameter_definition_name, origin)
VALUES ('CurrentLimitAutomaton', 'currentLimitAutomaton_OrderToEmit', 2),
       ('CurrentLimitAutomaton', 'currentLimitAutomaton_Running', 2),
       ('CurrentLimitAutomaton', 'currentLimitAutomaton_IMax', 2),
       ('CurrentLimitAutomaton', 'currentLimitAutomaton_tLagBeforeActing', 2);
...
INSERT INTO model_parameter_definitions (name, origin_name, type, fixed_value, created_date)
VALUES ('tapChangerBlocking_UMin', NULL, 2, NULL, now()::timestamp),
       ('tapChangerBlocking_tLagBeforeBlocked', NULL, 2, NULL, now()::timestamp),
       ('tapChangerBlocking_tLagTransBlockedD', NULL, 2, NULL, now()::timestamp),
       ('tapChangerBlocking_tLagTransBlockedT', NULL, 2, NULL, now()::timestamp);

INSERT INTO models_model_parameter_definitions (model_name, parameter_definition_name, origin)
VALUES ('TapChangerBlockingAutomaton', 'tapChangerBlocking_UMin', 2),
       ('TapChangerBlockingAutomaton', 'tapChangerBlocking_tLagBeforeBlocked', 2),
       ('TapChangerBlockingAutomaton', 'tapChangerBlocking_tLagTransBlockedD', 2),
       ('TapChangerBlockingAutomaton', 'tapChangerBlocking_tLagTransBlockedT', 2);
