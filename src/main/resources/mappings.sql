    ...
    create table model_parameter_sets (
       group_name varchar(255) not null,
        ...
        primary key (group_name, group_type, model_name, name)
    );
    ...
    create table model_parameters (
       group_name varchar(255) not null,
        ...
        value varchar(255),
        primary key (group_name, group_type, model_name, name, set_name)
    );
    ...
    create table model_sets_group (
       model_name varchar(255) not null,
        name varchar(255) not null,
        type int4 not null,
        primary key (model_name, name, type)
    );
...
create index rule_mappingName_index on rules (mappingName);
    ...
    alter table if exists model_parameter_sets 
       ...
       foreign key (model_name, group_name, group_type) 
       references model_sets_group;

    alter table if exists model_parameters 
       add constraint parameter_set_fk 
       foreign key (group_name, group_type, model_name, set_name) 
