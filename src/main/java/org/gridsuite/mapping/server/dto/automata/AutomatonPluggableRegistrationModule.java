...
import org.gridsuite.mapping.server.common.plugins.AbstractPluggableTypeRegistrationModule;
...
@Component
public class AutomatonPluggableRegistrationModule extends AbstractPluggableTypeRegistrationModule<AbstractAutomaton, AutomatonEntity> {
