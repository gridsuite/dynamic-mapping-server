...
public interface FilterClient {
    ...
    String FILTERS_BATCH_ENDPOINT = FILTERS_BASE_ENDPOINT + URL_DELIMITER + "batch";
    String FILTERS_GET_ENDPOINT = FILTERS_BASE_ENDPOINT + URL_DELIMITER + "metadata";
    String FILTERS_CREATE_IN_BATCH_ENDPOINT = FILTERS_BATCH_ENDPOINT;
    String FILTERS_UPDATE_IN_BATCH_ENDPOINT = FILTERS_BATCH_ENDPOINT;
    String FILTERS_DUPLICATE_IN_BATCH_ENDPOINT = FILTERS_BATCH_ENDPOINT + URL_DELIMITER + "duplicate";
